...
<head>
    ...
    <title>Privacy Policy | United states traveler</title>
</head>
    ...
    <main style="background-color: white;">
        <div class="container">
            <div class="header-title" style="padding: 4em 0; text-align: center;">
                ...
                <p style="font-size: 14px;">This Privacy Policy describes Our policies and procedures on the collection, use and disclosure of Your information when You use the Service and tells You about Your privacy rights and how the law protects You.</p>
            </div>
            ...
            <ul>
                ...
                <li>
                    <p><strong>Website</strong> refers to United states tours, accessible from <a href="<?php  echo $host_orginal; ?>" rel="external nofollow noopener" target="_blank"><?php  echo $host_orginal; ?></a></p>
                </li>
                <li>
